...
class WbLogisticTariffs(models.Model):
    ...
    box_delivery_base = models.FloatField(
        verbose_name="Доставка 1 литра, ₽", null=True, blank=True
    )
    ...
    box_storage_base = models.FloatField(
        verbose_name="Хранение 1 литра, ₽", null=True, blank=True
    )
    ...
    warehouseName = models.CharField(
        verbose_name="Название склада", max_length=255, null=True, blank=True
    )
    date_start = models.DateField(verbose_name="Дата", null=True, blank=True)
