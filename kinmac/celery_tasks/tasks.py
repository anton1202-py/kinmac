...
from check_report.supplyment import (
...
from database.supplyment import (
    ...
    add_data_sales_to_db,
    add_data_stock_from_api,
...
def error_message(function_name: str, function, error_text: str) -> str:
    ...
    message_error = (
        f"Ошибка в функции: {function_name}\n"
...
def sales_report_statistic():
    ...
    if common_data:
        ...
        for data in common_data:
            if not WeeklyReportInDatabase.objects.filter(
