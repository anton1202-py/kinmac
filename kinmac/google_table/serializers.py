...
class MarketplaceCommissionSerializer(serializers.ModelSerializer):
    ...
    width = serializers.CharField(source="marketplace_product.width")
    height = serializers.CharField(source="marketplace_product.height")
    length = serializers.CharField(source="marketplace_product.length")
